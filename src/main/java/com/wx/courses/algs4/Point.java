...
public class Point implements Comparable<Point> {
    ...
    private void checkNotNull(Point point) {
        if (point == null) {
    ...
    /**
     * Unit tests the com.wx.courses.algs4.Point data type.
     */
    ...
    private static class SlopeComparator implements Comparator<Point> {
        ...
        public int compare(Point o1, Point o2) {
            double slopeToO1 = origin.slopeTo(o1);
            double slopeToO2 = origin.slopeTo(o2);
